...
struct SettingsView: View {
    ...
    @ViewBuilder
    func sectionNotifications() -> some View {
        Section(
    ...
    @ViewBuilder
    func sectionIconPicker() -> some View {
        Section(
    ...
    @ViewBuilder
    func sectionAccentPicker() -> some View {
        Section(
    ...
    @ViewBuilder
    func sectionImportExport() -> some View {
        Section(
